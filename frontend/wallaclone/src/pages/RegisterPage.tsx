...
export default function RegisterPage() {
    ...
    // Simulando que existen usuarios mientras no está vinculado a la base de datos
    const existingUsers = [
        { username: "Marian", email: "marian@example.com" },
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Bienvenid@ <span className="font-semibold">{formData.username}</span>, tu cuenta ha sido creada.
                    </p>
                    <Link
                        to="/login"
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-10">
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#00bba7] hover:bg-[#009689] text-white font-semibold py-2.5 rounded-lg transition-colors cursor-pointer"
                    >
                        Crear cuenta
                    </button>
                </form>
